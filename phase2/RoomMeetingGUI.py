...
roomName_var = tk.StringVar()
roomName_label = tk.Label(top_frame, width=10, height=2, textvariable=roomName_var, font=("Arial", 20), bg="#2F5597", fg="#ffffff")
...
# set text
roomName_var.set("Room Name")
mute_var.set("Mute")
record_var.set("Start Record")
status_var.set("")

# test
createMember("Alice", 0, 0)
